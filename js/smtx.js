      ...
      switch (element.type)
      {
        ...
        case 'token_transfer': // Token transfer
          if(element.amount > 0)
          {
            ...
            <i>${day.toLocaleString()}</i> - <b>${element.player}</b> recieved <b>${element.amount}</b> ${tokentyp} from <b>${element.counterparty}</b>
            </li>`);
          }
          else
          {
            $("#view").append(`<li class="w3-padding-small w3-pale-red"><i class="fas fa-long-arrow-alt-down"></i>
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> send <b>${element.amount}</b> ${tokentyp} to <b>${element.counterparty}</b>
          </li>`);
          }
        break;
        case 'purchase_cl_presale_pack_voucher': // Buy pack (VOUCHER)
          ...
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> paid <b>${element.amount}</b> ${tokentyp} for <b>card pack</b>
          </li>`);
        break;
        ...
        case 'claim_staking_rewards': // SPS claim
          ...
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> claim <b>${element.amount}</b> ${tokentyp} for <b>(staking)</b>
          </li>`);
        break;
        ...
        case 'stake_tokens': // SPS stake
          ...
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> stake <b>${element.amount}</b> ${tokentyp}
          </li>`);
        break;
        case 'token_unstaking': // SPS UNSTAKE
          $("#view").append(`<li class="w3-padding-small w3-orange"><i class="fas fa-bolt"></i>
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> unstake <b>${element.amount}</b> ${tokentyp}
          </li>`);
        break;
        case 'tournament_prize': // Price tournament
          $("#view").append(`<li class="w3-padding-small w3-light-grey"><i class="fas fa-award"></i>
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> recieved <b>${element.amount}</b> ${tokentyp} <b>(tournament prize)</b>
          </li>`);
        break;
        case 'enter_tournament': // Tournament fee
          $("#view").append(`<li class="w3-padding-small w3-light-grey"><i class="far fa-circle"></i>
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> paid <b>${element.amount}</b> ${tokentyp} <b>(tournament fee)</b> 
          </li>`);
        break;
        case 'rental_payment_fees': // Rental fee
          $("#view").append(`<li class="w3-padding-small w3-light-grey"><i class="fas fa-funnel-dollar"></i>
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> paid <b>${element.amount}</b> ${tokentyp} <b>(Rental fee)</b> 
          </li>`);
        break;
        case 'rental_payment': // Rental payement +
          $("#view").append(`<li class="w3-padding-small w3-pale-green"><i class="fas fa-dollar-sign"></i>
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> earn <b>${element.amount}</b> ${tokentyp} <b>(Rental payment)</b> 
          </li>`);
        break;
        case 'market_rental': // Rental payement -
          $("#view").append(`<li class="w3-padding-small w3-pale-red"><i class="fas fa-dollar-sign"></i>
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> paid <b>${element.amount}</b> ${tokentyp} <b>(Rental payment)</b> 
          </li>`);
        break;
        case 'quest_rewards': // Quest reward
          $("#view").append(`<li class="w3-padding-small w3-pale-green"><i class="fas fa-dollar-sign"></i>
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> earn <b>${element.amount}</b> ${tokentyp} <b>(Quest rewards)</b> 
          </li>`);
        break;
        case 'dec_reward': // Match reward
          $("#view").append(`<li class="w3-padding-small w3-pale-green"><i class="fas fa-dollar-sign"></i>
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> earn <b>${element.amount}</b> ${tokentyp} <b>(Match rewards)</b> 
          </li>`);
        break;
        case 'season_rewards': // Season reward
          $("#view").append(`<li class="w3-padding-small w3-pale-green"><i class="fas fa-dollar-sign"></i>
          <i>${day.toLocaleString()}</i> - <b>${element.player}</b> earn <b>${element.amount}</b> ${tokentyp} <b>(Season rewards)</b> 
          </li>`);
        break;
